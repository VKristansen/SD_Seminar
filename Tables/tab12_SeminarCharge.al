table 50112 "CSD Seminar Charge"
{
    ...
    fields
    {
        ...
        {
            Caption = 'Quantity';
            DecimalPlaces = 0 : 5;//enter a minimum and maximum decimal places
        ...
        field(7; "Unit Price"; Decimal)
        {
            Caption = 'Unit Price';
            AutoFormatType = 2;
            MinValue = 0;//sets the minimum value of the field

            trigger OnValidate();
            begin
                "Total Price" := Round("Unit Price" * Quantity, 0.01);//the 0.01 is the last digit to round(precision)
            end;
        }

table 50131 "CSD Seminar Journal Line"
{
    ...
    fields
    {
        ...
        field(4; "Posting Date"; Date)
        {
            ...
            trigger OnValidate();
            //validate because by default the document date is equal to posting date
            begin
        ...
        {
            Caption = 'Source Code';
            Editable = false;//the default value of the editable is false
    ...
    keys
    {
        key(Key1; "Journal Template Name", "Journal Batch Name", "Line No.")//always the first key is defined as the primary key
        {
        }
    }
    //if both the seminar no. amd quantity fields are undefined 
    //then the journal line concidered empty

...
//     - Created new table
{
    ...
    fields
    {
        ...
        field(4; "Participant Contact No."; Code[20])
        {
            ...
            begin
                ...
                if ContactBusinessRelation.FindFirst then begin
                    ...
                    if page.RunModal(page::"Contact List", Contact) = Action::LookupOK then//The page is run modally and includes 
                        "Participant Contact No." := Contact."No.";                       //an OK and Cancel button for closing to modal popup
                end;
            ...
            begin
                ...
                then begin
                    ...
                    ContactBusinessRelation.SetRange("Link to Table", ContactBusinessRelation."Link to Table"::Customer);//Record.SETRANGE(Field [,FromValue] [,ToValue]) 
                    ContactBusinessRelation.SetRange("No.", "Bill-to Customer No.");//the SetRange is a filter
                    if ContactBusinessRelation.FindFirst then begin//FINDFIRST function searches for the first record in the table
        ...
        field(10; "Seminar Price"; Decimal)
        {
            ...
            AutoFormatType = 2;//defines the appearance of the field
    ...
    begin
        GLSetup.Get;
        Amount := Round("Seminar Price" - "Line Discount Amount", GLSetup."Amount Rounding Precision");//Round() = rounds a number
    end;
}

table 50132 "CSD Seminar Ledger Entry"
{
    ...
    //>>Chapter 8 Lab 2-3
    //add lookuppageid & drilldownpageid property
    ...
    fields
    {
        ...
        {
            Caption = 'Chargeable';
            InitValue = true;//Sets the initial value of this field when a user creates a new record
        }
        ...
        {
            Caption = 'User ID';
            //the User ID field relate to the User Name field of the table User
            TableRelation = user where ("User Name" = field ("User ID"));
            //is to enter a user that may not be in the user table
    ...
    keys
    {
        ...
        //chapter 8 lab 2-1 02/09/2019
        //add a secondary key to enable the navigation
